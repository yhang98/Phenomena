...
const CONNECTION_STRING = process.env.DATABASE_URL || 'postgres://postgres:postgres@localhost:5432/phenomena-dev';
...
async function closeReport(reportId, password) {
  try {
    ...
    if (report.isOpen === false) throw new Error("This report has already been closed")
